...
svm_Linear <- train(Affected ~., data = train_transformed, method = "svmLinear",
                    trControl=trctrl,
...
set.seed(3233)
svm_Linear_Grid <- train(Affected ~., data = train_transformed, method = "svmLinear",
                           trControl=trctrl,
                           preProcess = c("center", "scale"),
                           tuneGrid = grid,
                           tuneLength = 10)
...
svm_Radial <- train(Affected ~., data = train_transformed, method = "svmRadial",
                    trControl=trctrl,
                    preProcess = c("center", "scale"),
                    tuneLength = 10)
