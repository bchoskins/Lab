...
ada.roc <- roc(trainData$Affected, ada.fit$finalModel$votes[,2])
auc(ada.roc)
# > ada.fit$results
# nIter        method            ROC Sens Spec           ROCSD SensSD SpecSD
# 1    50   Adaboost.M1 0.478936176063    1    0 0.0352064852760      0      0
# 2    50 Real adaboost 0.500983604288    1    0 0.0146742612308      0      0
# 3   100   Adaboost.M1 0.477817958690    1    0 0.0384296378999      0      0
# 4   100 Real adaboost 0.503895364675    1    0 0.0117902087111      0      0
# 5   150   Adaboost.M1 0.480242531583    1    0 0.0408320829809      0      0
# 6   150 Real adaboost 0.504130307908    1    0 0.0136057807746      0      0
